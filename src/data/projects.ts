...
export const privateCases: PortfolioProject[] = [
  ...
  },
  {
    slug: 'nuvkey',
    title: 'Nuvkey',
    subtitle: 'Atalhos, perfis e automações para Windows',
    description:
      'Aplicativo Windows que transforma teclados USB em painéis de atalhos, perfis e automações, com edições Essential, Macro e Pro planejadas.',
    stack: ['C#', '.NET 10', 'WPF', 'Windows API'],
